				...
				<Row className='mt-5 mx-5 main-border'>
						...
						<Col md={12} className='mt-3'>
							<p>
								...
								like LSD and Mushrooms, do not use this calculator for a
								chemcial that isn't a tryptamine (it will not be accurate).
							</p>
							<p>
								This calculator is only able to provide an approximation. With
								that being said, this calculator also assumes that you know
								exactly how much LSD and Shrooms you have consumed. Always
								measure your mushies and make sure you have a reputable LSD
								vendor with accurate doses.
							</p>
							<p>
								As all bodies and brains are different, results may vary of
								course regarding tolerance. Use this calculator as a general
								rule of thumb.
							</p>
							<p>
								It is strongly suggested to let 2 weeks pass between each trip.
								For most people, tolerance should be back to normal after every
								14 days.
							</p>
